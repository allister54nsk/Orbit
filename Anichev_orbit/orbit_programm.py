...
def get_speed_classification(speed, first_cosmic, second_cosmic):
    ...
    if speed < first_cosmic:
        return "Скорость меньше 1-й космической: траектория падения/суборбитальная траектория."
...
if __name__ == "__main__":
    ...
    print("РЕЗУЛЬТАТЫ РАСЧЕТА ПАРАМЕТРОВ ОРБИТЫ МАЕГО ВАРИАНТА")  # Заголовок
    print("=" * 80)  # Разделительная линия
